...
app.controller('EquipeCtrl', function($rootScope, $location){
    ...
    $rootScope.equipe = [
    {
      ...
      'descricao':'Pedagoga, especialista em Alfabetização, Leitura e Escrita pela UFRJ.',
      ...
      'descricao':'Pedagoga e psicopedagoga.',
      'imagem':path+'/app/images/Elisabete.jpg'
    },{
      'nome':'Tarna Morena',
      'descricao':'Professora de História e Inglês e Psicopedagoga.',
